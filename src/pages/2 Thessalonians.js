...
const Thessalonians_2 = () => (
  <Book_layout dll_txt="2 Thessalonians.txt" book_title="2 Thessalonians (KJV)">
    <SEO title="2 Thessalonians" />
    <p>
      ...
      grace of our God and the Lord Jesus Christ. Now we beseech you, brethren,
      ...
      in unrighteousness. But we are bound to give thanks alway to God for you,
      ...
      glory of our Lord Jesus Christ. Therefore, brethren, stand fast, and hold
      ...
      tradition which he received of us. For yourselves know how ye ought to
      ...
      night and day, that we might not be chargeable to any of you: Not because
      we have not power, but to make ourselves an ensample unto you to follow
      ...
      be not weary in well doing. And if any man obey not our word by this
      epistle, note that man, and have no company with him, that he may be
      ashamed. Yet count him not as an enemy, but admonish him as a brother. Now
      the Lord of peace himself give you peace always by all means. The Lord be
      with you all. The salutation of Paul with mine own hand, which is the
      token in every epistle: so I write. The grace of our Lord Jesus Christ be
      with you all. Amen.
    </p>
  </Book_layout>
)

export default Thessalonians_2
