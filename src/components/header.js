...
const Header = ({book_title, dll_txt}) => {
  ...
  <div className="nav_bar">
     ...
     <Link to="/"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-house-door" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <svg onClick={() => set_light_mode(!light_mode)} width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-lightning" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <a href={"/bible_txt/" + dll_txt} download={dll_txt}>
    <svg   width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-file-earmark-arrow-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
